...
export class PurchaseRouter extends BaseRouter<PurchaseController> {
    ...
    routes():void{
        this.router.get("/purchase", (req,res) => this.controller.getPurchase(req,res));
        ...
        this.router.delete("/deletePurchase/:id", (req,res) => this.controller.deletePurchase(req,res));
    }
}